        ...
        [ div [ class "table-responsive" ]
            [ table [ class "table table-striped table-hover" ]
                ...
                , tbody []
                    ...
                    , tr [ class "pace_data_duration pace_data_units_metric hidden" ]
                        [ th [ class "fit", scope "row" ]
                            [ text "Distance (KM)" ]
                        , td []
                            []
                        ]
                    , tr [ class "pace_data_duration pace_data_units_imperial hidden" ]
                        [ th [ class "fit", scope "row" ]
                            [ text "Distance (Mi)" ]
                        , td []
                            []
                        ]
                    , tr [ class "pace_data_calories hidden" ]
                        [ th [ class "fit", scope "row" ]
                            [ text "Calories" ]
                        , td []
                            []
